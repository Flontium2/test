...
function CreateGUiOpen()
	...
	FrameTest.Name = "AXCFrame"
	FrameTest.Parent = ScreenGui
	FrameTest.BackgroundColor3 = Color3.fromRGB(31, 31, 31)
	FrameTest.BorderSizePixel = 0
	FrameTest.Draggable = true
	FrameTest.Position = UDim2.new(0.120833337, 0, 0.0952890813, 0)
	FrameTest.Size = UDim2.new(0, 50, 0, 50)
	FrameTest.Font = Enum.Font.SourceSans
	FrameTest.Text = ""
	FrameTest.TextColor3 = Color3.fromRGB(0, 0, 0)
	FrameTest.TextSize = 14.000
	FrameTest.MouseButton1Click:Connect(function()
		CoreGui.EvoHub.Main.Position = UDim2.new(0.41776669, -314, 0.194183752, -85)
		CoreGui.AXCScreenGui:Destroy()
	end)

	AXCCor.Name = "AXCCor"
	AXCCor.Parent = FrameTest

	MODILEMAGE.Name = "MODILEMAGE"
	MODILEMAGE.Parent = FrameTest
...
function Library:CreateWindow(name)
	...
	Main.Size = UDim2.new(0, 690, 0, 480)
	...
	Logo.Image = "http://www.roblox.com/asset/?id=16135396728"
...
local Win = Library:CreateWindow('Abc') 
local Tab  = Win:CreateTab('Main')
Tab:Button("Test","",function()
    warn("Test")
end)
Tab:Toggle("Test1","",false,function(v)
    _G.Test = v
end)
...
Tab:DropDown("DropDown","Test",{"1","2"},function(v)
    print(v)
end)
return Library
