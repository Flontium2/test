...
ImageButton.Size = UDim2.new(0, 85, 0, 90)
...
spawn(function()
    while game:GetService("RunService").Stepped:wait() do
        pcall(function()
            if NoClip or _G.AutoFarmKata then
            ...
            pcall(function()
                if game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince") then
                    ...
                    if game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince") then
                        center =  game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince").HumanoidRootPart.CFrame * CFrame.new(0,-5,0)
                        topos(getPosition(10,5))
                    else
                        if KillMob == 0 then
                        end                    
                        if game:GetService("Workspace").Map.CakeLoaf.BigMirror.Other.Transparency == 1 then
                            ...
                            if game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince") then
                                center = game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince").HumanoidRootPart.CFrame * CFrame.new(0,-5,0)
                                topos(getPosition(10,5))
                           else
                                if game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince") then
                                    center = game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince").HumanoidRootPart.CFrame * CFrame.new(0,-5,0)
...
Tabs.Main:AddParagraph({
    Title = "Setting Farm BF Mastery",
    Content = "Auto Farm Mastery Fruit"
})
...
local FarmBF = Tabs.Main:AddToggle("FarmBF", {Title = "Auto Farm Fruit Mastery", Default = false })

FarmBF:OnChanged(function(Value)
...
local FarmGun = Tabs.Main:AddToggle("FarmGun", {Title = "Auto Farm Gun Mastery", Default = false })

FarmGun:OnChanged(function(Value)
...
if World2 or World3 then
    ...
    local FullRaid = Tabs.Raid:AddToggle("FullRaid", {Title = "Full Raid", Default = false })

    FullRaid:OnChanged(function(Value)
        FullRaidBeta = Value
    end)
    ...
    function CheckTime()
        timer = game.Players.LocalPlayer.PlayerGui.Main.Timer.Visible == true
        checkraid2 = NextIsland()
        if timer then
            return timer
        end
        return checkraid2
    ...
    spawn(function()
        while wait() do
            pcall(function()
                if CheckTime() and FullRaidBeta and (World2 or World3) then
                    if NextIsland() then
                ...
                elseif (World2 or World3) and FullRaidBeta then
                    local buy = game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("RaidsNpc", "Select", _G.SelectChip) == 1
                    if WOrld2 then
...
spawn(function()
            ...
            for i,v in pairs(game.Workspace.Boats:GetChildren()) do
                if game:GetService("Workspace").Boats[_G.Boat] then
                    if not v:FindFirstChild("VehicleSeat") and v:FindFirstChild("Humanoid") then
                        if (game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame - game:GetService("Workspace").Boats[_G.Boat].VehicleSeat.CFrame).Magnitude > 1500 then
    ...
    local SelectZone = Tabs.SeaEvent:AddDropdown("SelectZone", {
        Title = "Select Zone",
        Values = {"Zone 0", "pcallZone 1", "Zone 2", "Zone 3", "Zone 4", "Zone 5", "Zone 6"},
        Multi = false,
        Default = 1,
    })
    ...
    local AutoSummon = Tabs.Misc:AddToggle("AutoSummon", {Title = "Auto Summon Mirage Island", Default = false })
            ...
            for _, v in next, workspace.Boats.PirateBrigade:GetDescendants() do
                if v.Name:find("VehicleSeat") then
                    ...
                    if game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then
                        to(game:GetService("Workspace").Map:FindFirstChild("MysticIsland").HumanoidRootPart.CFrame * CFrame.new(0, 500, -100))
                    end
                end
            end
        end
    ...
    spawn(function()
        ...
        local LockCamToMoon = Tabs.Misc:AddToggle("LockCamToMoon", {Title = "Auto Lock Cam to Moon", Default = false })

        LockCamToMoon:OnChanged(function(Value)
            _G.LockCam = Value
            if not _G.LockCam then
                _G.LockCam = false
            end
        end)
        ...
        local TPGear = Tabs.Misc:AddToggle("TPGear", {Title = "Teleport to Gear in Mirage", Default = false })

        TPGear:OnChanged(function(Value)
            _G.TweenMGear = Value
