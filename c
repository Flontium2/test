...
-- local FarmAllSw = Tabs.Main:AddToggle("FarmAllSw", {Title = "Auto Farm All Sword 600 mastery", Default = false })

-- FarmAllSw:OnChanged(function(Value)
...
--                                                         game:GetService("VirtualUser"):CaptureController()
--                                                         game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
--                                                     until not _G.FarmAllSwordMas or not v.Parent or v.Humanoid.Health <= 0 or game:GetService("Workspace").Map.CakeLoaf.BigMirror.Other.Transparency == 0 or game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince") or game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince") or KillMob == 0
--                                                 end
--                                             end
--                                         end
--                                     else
...
NoClipRock:OnChanged(function(Value)
    ...
    local SelectBoat = Tabs.SeaEvent:AddDropdown("SelectBoat", {
        Title = "Select Boat",
        Values = {"PirateBrigade", "PirateGrandBrigade","PirateSloop"},
        Multi = false,
        Default = 1,
    })
