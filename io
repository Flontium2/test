...
local Q = require(game.ReplicatedStorage.Quests)
    ...
    function getNextIsland()
        ...
        for r, v in pairs(TableIslandsRaid) do
            if
                IsIslandRaid(v) and
                    (IsIslandRaid(v).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 4500 then
                        ...
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == "Cake Prince" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    ...
                                    until not AutoFarmKata or not v.Parent or v.Humanoid.Health <= 0
                                end
                            end
                        end
                    else
                                        ...
                                        if v.Name == "Cookie Crafter" or v.Name == "Cake Guard" or v.Name == "Baking Staff" or v.Name == "Head Baker" then
                                            if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                                repeat task.wait()
                                                    ...
                                                    game:GetService("VirtualUser"):CaptureController()
                                                    game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                                until not AutoFarmKata or not v.Parent or v.Humanoid.Health <= 0 or game:GetService("Workspace").Map.CakeLoaf.BigMirror.Other.Transparency == 0 or game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince") or game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince") or KillMob == 0
                                            end
                                        end
                                    end
                                else
                                    MagnetDought = false
                                    GetTpNearest(CFrame.new(-1580.6512451171875, 329.84356689453125, -12308.4677734375))
...
local AcceptQuest = Tabs.Settings:AddToggle("AcceptQuest", {Title = "Accept The Quest Cake Prince or Bone", Default = false })
...
spawn(function ()
    while wait() do
        if AutoAcceptQuest then
            if AutoFarmBone and game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
            ...
            elseif AutoFarmKata and game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
...
spawn(function()
    while task.wait() do
        if _G.BringMob then
            S()
            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                if AutoFarmLv and StartMagnet and v.Name == Mon and (Mon == "Factory Staff" or Mon == "Monkey" or Mon == "Dragon Crew Warrior" or Mon == "Dragon Crew Archer") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 220 then
                    v.HumanoidRootPart.Size = Vector3.new(70,70,70)
                ...
                elseif AutoFarmLv and StartMagnet and v.Name == Mon and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 300 then
                    v.HumanoidRootPart.Size = Vector3.new(70,70,70)
                    v.HumanoidRootPart.CFrame = PosMon
                    v.Humanoid:ChangeState(14)
                    v.HumanoidRootPart.CanCollide = false
...
spawn(function()
    while wait() do
        if _G.BringMob then
            for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                if AutoFarmBone and StartMagnetBoneMon then
                ...
                if AutoFarmKata and MagnetDought then
