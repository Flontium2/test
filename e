...
spawn(function()
    while task.wait() do
        if (World2 or World3) and FullRaidBeta and CheckTime() then
            pcall(function()
                if NextIsland() then
        ...
        elseif (World2 or World3) and FullRaidBeta then
            local buy = game.ReplicatedStorage.Remotes.CommF_:InvokeServer("RaidsNpc", "Select", _G.SelectChip) == 1
            if World2 then
