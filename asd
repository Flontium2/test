...
function Bypass(P1)
    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - P1.Position).Magnitude >= 1000 then
        pcall(function()
...
function GetQuest()
    ...
    elseif Distance >= 1000 then
        Bypass(CFrame.new(60878.30078125, 18.482830047607422, 1543.7574462890625))
    else
        topos(CFrameQuest())
    end
end
                ...
                for i, v in pairs(GetMobSpawnList(GetMob())) do
                    pcall(function()
                        if not MobLevel1OrMobLevel2() and getgenv().Kaitun then
                            ...
                            set_content("Task: Waiting ".. MobLevel1OrMobLevel2())
                        end
                    end)
                end
            else
                    ...
                    for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
                        if v.Name == MobLevel1OrMobLevel2() and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 and game.Players.LocalPlayer.PlayerGui.Main:FindFirstChild("Quest").Visible then
                            repeat task.wait()
                                ...
                                set_content("Task: Killing " .. v.Name)
...
function Auto_Saber()
    set_content("Auto Farm: Get Saber")
    while task.wait() do
...
task.spawn(function()
    while task.wait() do
        if getgenv().Kaitun then
            ...
            if level >= 1 and level < 14 and not Auto_Saber() or level > 310 and level <= 700 then
                pcall(function()
                    FarmLevel()
                end)
